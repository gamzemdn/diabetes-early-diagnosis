...
public class OntologyFunctions {
    ...
    public static final File localLocation_IRI = new File("c://ONTOLOGIES/yeniontology.owl");
  ...
  public Set<String> getAnnotation(String ind) 
 { 
     // OWLClass cust = f.getOWLClass(IRI.create("http://purl.obolibrary.org/obo/"+entity));
      OWLNamedIndividual tc = f.getOWLNamedIndividual(IRI.create(Ont_Base_IRI+ "#" + ind));
      OWLEntity entity= (OWLEntity) tc;
  Set<String> annotations = new HashSet<String>(); 
  try 
  { 
   OWLAnnotationProperty owlAnnotationProperty = f.getOWLAnnotationProperty(IRI.create("http://purl.obolibrary.org/obo/IAO_0000115")); 
   for (OWLAnnotation annotation : entity.getAnnotations(o, owlAnnotationProperty)) 
   { 
...
//        OntologyFunctions ahmet = new OntologyFunctions();
//        ahmet.saveClassAssertion("CONSUMER", "TC01");
//        ahmet.SAVEOTP("TC01", "HAS_ALLERGY", "BALIK");
//        ahmet.SaveDTPInteger("TC01", "HAS_AGE", 25);
//        
//        System.out.println("\n");
//        System.out.println(ahmet.getAnObjectProperty("TC01", "HAS_RECOMMEND"));
//        
//        
//        ahmet.removeClassAssertion("CONSUMER", "TC01");
//        ahmet.removeOTP("TC01", "HAS_ALLERGY", "BALIK");
//        ahmet.removeDTPInteger("TC01", "HAS_AGE", 25);
//        
//    }
}
